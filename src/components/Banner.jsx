...
const Banner = () => {
  return (
    <div className="relative w-full h-[600px]">
      ...
      <div className="absolute inset-0 flex px-10 flex-col md:flex-row items-center justify-between text-white bg-black/70">
        <div className="md:w-1/2">
          ...
          <div className="flex items-center gap-7 mt-7">
            <button className="border rounded-full px-5 py-2 bg-blue-900 text-white flex items-center gap-2">
             <FaCalendarAlt></FaCalendarAlt> Appointment
            </button>
            <button className="border rounded-full px-7 py-2 flex items-center gap-2">
